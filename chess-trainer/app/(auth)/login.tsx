    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.tagline}>Your chess journey begins here</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <Button label="LOG IN" onPress={handleLogin} loading={loading} size="lg" />
...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 72, lineHeight: 80 },
  appName: {
  ...
  tagline: { fontSize: Typography.sizes.base, color: Colors.textSecondary },
